...
while True:
    ...
    if ret:
        ...
        if face_match == opt_matches.EG:
            cv2.putText(frame, "MATCH, WITH EYEGLASSES!", (20, 450), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2) 
        elif face_match == opt_matches.NO_EG:
            cv2.putText(frame, "MATCH, NO EYEGLASSES!", (20, 450), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2) 
        else: 
            cv2.putText(frame, "NOT YOU!", (20, 200), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
